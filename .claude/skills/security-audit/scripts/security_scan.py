...
def run_bandit(project_path: Path) -> ScanResult:
    ...
    try:
        ...
        return ScanResult(
            ...
            success=False,
            findings=[],
            error="bandit not installed. Run: uv add --dev bandit",
        )
...
def run_pip_audit() -> ScanResult:
    ...
    try:
        ...
        return ScanResult(
            ...
            success=False,
            findings=[],
            error="pip-audit not installed. Run: uv add --dev pip-audit",
        )
    except Exception as e:
        return ScanResult(
            tool="pip-audit",
...
def run_safety() -> ScanResult:
    ...
    try:
        ...
        return ScanResult(
            ...
            success=False,
            findings=[],
            error="safety not installed. Run: uv add --dev safety",
        )
    except Exception as e:
        return ScanResult(
            tool="safety",
...
def check_secrets(project_path: Path) -> ScanResult:
    ...
    try:
        ...
        return ScanResult(
            ...
            success=False,
            findings=[],
            error="detect-secrets not installed. Run: uv add --dev detect-secrets",
        )
    except Exception as e:
        return ScanResult(
            tool="detect-secrets",
